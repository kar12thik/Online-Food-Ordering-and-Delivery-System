...
export default class AddMenuItems extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="container mx-auto register-cont1">
          <div className="">
            {/* <Navbar history={this.props.history} /> */}
            {/* <Navbar2 history={this.props.history} /> */}
            <div className="container mx-auto register-cont1-text">
              <h1 className="uppercase text-white text-center mb-4">
                <strong>Add Your Best Food Items</strong>
              </h1>
            </div>
          </div>
        </div>
        <div className="container mx-auto py-5 bg-gray-100">
          <div className="lg:col-span-6 md:col-span-6 sm:col-span-12 mx-auto bg-white shadow p-4">
