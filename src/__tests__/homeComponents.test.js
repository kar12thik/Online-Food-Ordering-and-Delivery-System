...
test("should render static content on search restaurants component", () => {
  ...
  test("should render static content and button on order now component", () => {
    ...
    expect(screen.getByText("JUST ORDER AND WE WILL DELIVER YOU")).toBeInTheDocument();
    expect(screen.getByText("Avoid the lines and have food delivered by us")).toBeInTheDocument();
  });
