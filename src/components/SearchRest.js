  ...
  <form class="m-auto items-center">
    ...
    <div class="mx-auto flex w-auto content-center justify-center">
      <div class=" inset-y-0 flex items-center ">
        ...
        <input type="text" id="simple-search" class="block sm:w-auto md:w-80 lg:w-96 rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Search Restaurants..." required />
      </div>
