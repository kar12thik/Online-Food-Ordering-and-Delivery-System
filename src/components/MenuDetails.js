...
const MenuDetails = (props) => {
  ...
  <div class="flex justify-center">
    <div class="tabs">
    <button class="tablinks bg-blue-500 hover:bg-blue-700 text-white font-bold h-12 px-6 mb-0 mr-16" onClick="openTab(event, menu)">Menu</button>
    &nbsp;
      &nbsp;
      &nbsp;
      &nbsp;
      ...
      <button class="tablinks bg-blue-500 hover:bg-blue-700 text-white font-bold h-12 px-6 mx-4 mr-24" onClick="openTab(event, reviews)">Reviews</button>
      &nbsp;
      ...
      <button class="tablinks bg-blue-500 hover:bg-blue-700 text-white font-bold h-12 px-6 mx-4" onClick="openTab(event, info)">Info</button>
    
      <div id="menu" class="tabcontent">
    <div class="col-10 bg-white p-4 h-100">
      <div class="row p-3">
        <div class="col-3 pl-0">
          <div class="bg-orange col-2 p-2 h-50 w-24"></div>
  ...
  <div id="reviews" class="tabcontent">
    <div class="row">
      <div class="col-10 bg-white p-4">
        <div class="row p-3">
          <div class="col-3 pl-0">
            <p class="mb-0"><strong>Write your own reviews</strong></p>
            <small class="text-danger">Only customers can write reviews</small>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="col-2 bg-white p-14 h-64 w-100">
