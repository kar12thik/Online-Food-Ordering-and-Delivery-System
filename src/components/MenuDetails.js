...
function MenuDetails({ items, addToCart }) {
  ...
  const [menuDetailList, setMenuDetailList] = useState(items);
  //console.log(items);
  ...
  function onSearch(query) {
    if (query !== "") {
      const temp = menuDetailList.filter((item) =>
